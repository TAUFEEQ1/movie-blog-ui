  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 relative overflow-hidden">
    ...
    <div class="relative z-10 px-4 sm:px-8 lg:px-16 py-6">
      ...
      <div class="max-w-screen-xl mx-auto text-center mb-16">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 w-full max-w-lg mx-auto">
          <NuxtLink 
            to="/register" 
            class="w-full sm:w-64 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl text-white font-semibold hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 flex items-center justify-center gap-2 whitespace-nowrap"
          >
            <Icon name="mdi:rocket" class="w-5 h-5" />
            Start Your Journey
          </NuxtLink>
